...
class TestAccountsViews(TestCase):
    ...
    def test_duplicated_check(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:duplicated_check") + f"?email={self.user.email}")
    ...
    def test_post_login_page_with_unregistered_user(self) -> None:
        ...
        data = {"email": unvalid_email, "password": unvalid_password}
    ...
    def test_redirect_when_logged_in_user_get_login_page(self) -> None:
        ...
        self.assertRedirects(response=response, expected_url=reverse("accounts:mypage"))
    ...
    def test_post_profile_change(self) -> None:
        ...
        # When
        response = self.client.post(reverse("accounts:profile_change"), data=data)
    ...
    def test_post_profile_image_change(self) -> None:
        ...
        self.assertEqual("changed_bio", changed_user.bio)
        self.assertEqual(
            changed_user.img.name, img_upload_to + username + domain.split(".")[0] + domain.split(".")[1] + "-" + datetime.now().strftime("%Y-%m-%d") + "." + img_extension
        )
    ...
    def test_get_search_friend(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:search_friend") + f"?q={query}")
        ...
        self.assertEqual(1, response.json()["result"][0]["is_friend"])
        self.assertEqual(current_user.id, response.json()["result"][0]["id"])
    ...
    def test_view_search_friend_returns_none(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:search_friend") + f"?q={invalid_query}")
    ...
    def test_send_friend_request(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:send_request", kwargs={"receiver_id": user2.id}))
    ...
    def test_accept_friend_request(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:accept_request", kwargs={"request_id": friend_request.id}))
        friend_requests = FriendRequest.objects.all()
    ...
    def test_decline_friend_request(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:decline_request", kwargs={"request_id": friend_request.id}))
        friend_requests = FriendRequest.objects.all()
    ...
    def test_send_temporary_password(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:temporary_password") + f"?q={email}")
    ...
    def test_send_temporary_password_with_unvalid_email(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:temporary_password") + f"?q={unvalid_email}")
    ...
    def test_auth_check(self) -> None:
        ...
        # When
        response = self.client.post(reverse("accounts:auth_check"), data=data)
    ...
    def test_view_remove_friend(self) -> None:
        ...
        # When
        response = self.client.get(reverse("accounts:remove_friend", kwargs={"friend_id": self.user2.id}))
