...
class TestLikeService(TestCase):
    def test_do_like_youtube_service(self) -> None:
        ...
        password = "testuser1"
        bio = "testuser1"
        user = CustomUser.objects.create_user(email=email, nickname=nickname, password=password, bio=bio)
    ...
    def test_do_like_shopping_service(self) -> None:
        ...
        # When
        like_shopping = do_like_shopping_service(user_id, title, price, thumbnail_url, link_url)
    ...
    def test_do_like_news_service(self) -> None:
        ...
        # When
        like_news = do_like_news_service(user_id, title, date, company, content, thumbnail_url, link_url)
