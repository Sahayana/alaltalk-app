...
def do_like_youtube_service(
    user_id: int, youtube_url: str, title: str, views: str
) -> str:
...
def do_like_shopping_service(
    user_id: int, title: str, price: str, thumbnail_url: str, link_url: str
) -> str:
    user = CustomUser.objects.get(pk=user_id)
